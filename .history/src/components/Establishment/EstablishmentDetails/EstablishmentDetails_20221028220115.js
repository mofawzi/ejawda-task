                ...
                <div className="facility-info_type">
                    ...
                    <div>
                        ...
                        <p className="facility-info--info">
                            <FormattedMessage id={props.details.type} />
                        </p>
                    </div>
                </div>
            </div>
            <div className="col-3">
                <div className="facility-info_date">
                    ...
                    <div>
                        ...
                        <p className="facility-info_info">{props.details.expirationDate}</p>
                    </div>
                </div>
            </div>
            <div className="col-3">
                <div className="facility-info_uniform-number">
                    ...
                    <div>
                        ...
                        <p className="facility-info_info">{props.details.unicode}</p>
                    </div>
                </div>
            </div>
            <div className="col-3">
                <div className="facility-info_facility-number">
                    ...
                    <div>
                        ...
                        <p className="facility-info_info">
                            {props.details.commercialNumber}
                        </p>
                    </div>
                </div>
            </div>
