...
const EstablishmentDetails = (props) => {
    return (
        <section className="facility-info row mt-25">
            <div className="col-3">
                <div className="facility-info__type">
                    <div>
                        <i className="bi bi-building fs-4 text-primary mx-5"></i>
                    </div>
                    <div>
                        <p className="facility-info--name mb-5">
                            <FormattedMessage
                                id="instituteType"
            ...
            <div className="col-3">
                <div className="facility-info__date">
                    <div>
                    ...
                    <div>
                        ...
                        <p className="facility-info--info">{props.info.expirationDate}</p>
                    </div>
                </div>
            </div>
            <div className="col-3">
                <div className="facility-info__uniform-number">
                    <div>
                    ...
                    <div>
                        ...
                        <p className="facility-info--info">{props.info.unicode}</p>
                    </div>
                </div>
            </div>
            <div className="col-3">
                <div className="facility-info__facility-number">
                    <div>
